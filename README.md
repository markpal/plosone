...
<ul>
  ...
  <li><code>cuda/</code> – CUDA implementation</li>
...
For example:<br>
<code>icpx -O3 -qopenmp -xCORE-AVX512 -qopt-report=max -qopt-report-phase=vec -qopt-report-file=vec_report.txt nussinov.cpp</code>
<h3>Configuration</h3>
